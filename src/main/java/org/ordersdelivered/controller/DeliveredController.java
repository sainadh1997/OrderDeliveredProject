...
public class DeliveredController {
	...
	public String addDelivered(@Valid @ModelAttribute("deliver") OrdersDeliveryDetails deliver, BindingResult error,
			Model uiModel) throws SQLException {
		if (error.hasErrors()) {
	...
	public String editDeliverRecord(@Valid @ModelAttribute("deliver") OrdersDeliveryDetails deliver,
			BindingResult error, Model uiModel) {
